...
import com.shopapp.web.rest.dto.EntityAuditEvent;
...
public class JaversEntityAuditResource {
    ...
    public List<String> getAuditedEntities() {
        return Arrays.asList("Order", "OrderItem", "Queue");
    }
    ...
    public ResponseEntity<List<EntityAuditEvent>> getChanges(
        ...
        Class entityTypeToFetch = Class.forName("com.shopapp.domain." + entityType);
    ...
    public ResponseEntity<EntityAuditEvent> getPrevVersion(
        ...
        Class entityTypeToFetch = Class.forName("com.shopapp.domain." + qualifiedName);
