...
class OrderItemResourceIT {
    ...
    void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getCode()).isEqualTo(DEFAULT_CODE);
    ...
    void putExistingOrderItem() throws Exception {
        ...
        OrderItem testOrderItem = orderItemList.get(orderItemList.size() - 1);
        assertThat(testOrderItem.getCode()).isEqualTo(UPDATED_CODE);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.code(UPDATED_CODE).unitPrice(UPDATED_UNIT_PRICE).quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE);
