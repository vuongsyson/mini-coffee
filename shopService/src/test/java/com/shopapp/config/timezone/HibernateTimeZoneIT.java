package com.shopapp.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.shopapp.IntegrationTest;
import com.shopapp.repository.timezone.DateTimeWrapper;
import com.shopapp.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM shop_date_time_wrapper where id=%d", fieldName, id);
    }
