...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.shopapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.shopapp.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
