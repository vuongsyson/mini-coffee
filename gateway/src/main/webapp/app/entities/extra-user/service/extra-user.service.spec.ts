...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../extra-user.test-samples';

import { ExtraUserService, RestExtraUser } from './extra-user.service';

const requireRestSample: RestExtraUser = {
...
describe('ExtraUser Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a ExtraUser', () => {
      ...
      const extraUser = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(extraUser).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a ExtraUser', () => {
      const extraUser = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(extraUser).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addExtraUserToCollectionIfMissing', () => {
      it('should add a ExtraUser to an empty array', () => {
        const extraUser: IExtraUser = sampleWithRequiredData;
      ...
      it("should add a ExtraUser to an array that doesn't contain it", () => {
        const extraUser: IExtraUser = sampleWithRequiredData;
        const extraUserCollection: IExtraUser[] = [sampleWithPartialData];
        expectedResult = service.addExtraUserToCollectionIfMissing(extraUserCollection, extraUser);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(extraUser);
      });
      ...
      it('should add only unique ExtraUser to an array', () => {
        const extraUserArray: IExtraUser[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const extraUserCollection: IExtraUser[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const extraUser: IExtraUser = sampleWithRequiredData;
        const extraUser2: IExtraUser = sampleWithPartialData;
    ...
    describe('compareExtraUser', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareExtraUser(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareExtraUser(entity1, entity2);
        const compareResult2 = service.compareExtraUser(entity2, entity1);
