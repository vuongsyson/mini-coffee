...
describe('ExtraUser routing resolve service', () => {
  ...
  let resultExtraUser: IExtraUser | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultExtraUser).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IExtraUser>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
